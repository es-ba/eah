...
grant select, insert, update, references on "ut_2023_actividades_calculada" to eah_admin;
grant all on "ut_2023_actividades_calculada" to eah_owner;
...
grant select, insert, update, references on "ut_2023_hogares_calculada" to eah_admin;
grant all on "ut_2023_hogares_calculada" to eah_owner;
...
grant select, insert, update, references on "ut_2023_hogares_sup_calculada" to eah_admin;
grant all on "ut_2023_hogares_sup_calculada" to eah_owner;
...
grant select, insert, update, references on "ut_2023_personas_calculada" to eah_admin;
grant all on "ut_2023_personas_calculada" to eah_owner;
...
grant select, insert, update, references on "ut_2023_personas_sup_calculada" to eah_admin;
grant all on "ut_2023_personas_sup_calculada" to eah_owner;
...
grant select, insert, update, references on "ut_2023_tem_calculada" to eah_admin;
grant all on "ut_2023_tem_calculada" to eah_owner;
...
grant select, insert, update, references on "ut_2023_visitas_calculada" to eah_admin;
grant all on "ut_2023_visitas_calculada" to eah_owner;
...
grant select, insert, update, references on "ut_2023_visitas_sup_calculada" to eah_admin;
grant all on "ut_2023_visitas_sup_calculada" to eah_owner;
...
grant select, insert, update, references on "ut_2023_viviendas_calculada" to eah_admin;
grant all on "ut_2023_viviendas_calculada" to eah_owner;
          ...
          UPDATE ut_2023_personas_calculada
            SET 
              cant_cod_11 = actividades_agg.cant_cod_11,
                ...
                cant_cod_61 = actividades_agg.cant_cod_61,
                cant_cod_911 = actividades_agg.cant_cod_911,
                cant_cod_912 = actividades_agg.cant_cod_912,
            ...
            FROM "personas"  
              ,LATERAL (
                ...
                count(nullif(CASE WHEN "actividades"."codigo"=61 THEN true ELSE NULL END,false)) as cant_cod_61,
                count(nullif(CASE WHEN "actividades"."codigo"=911 THEN true ELSE NULL END,false)) as cant_cod_911,
                count(nullif(CASE WHEN "actividades"."codigo"=912 THEN true ELSE NULL END,false)) as cant_cod_912,
